...
for (let i = 0; i < objectLength; i++) {
  ...
  //console.log(`The Publisher Is ${Object.values(myFavGames)[i].publisher}`);  //valid
  console.log(`The Publisher Is ${myFavGames[Object.keys(myFavGames)[i]].publisher}`);  //valid
